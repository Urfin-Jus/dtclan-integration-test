...
class NEC_NAT_MO extends MONITORED_OBJECT {

    NEC_NAT_MO(String id,String uuid, String name){
        mo_type = 'nec-nat'
        expected_metrics = ["9149468490251733105","9148777916851236947","9149468464151731705",
