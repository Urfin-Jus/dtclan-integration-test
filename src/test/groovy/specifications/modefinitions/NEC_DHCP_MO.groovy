...
class NEC_DHCP_MO extends MONITORED_OBJECT {

	NEC_DHCP_MO(String id,String uuid,String name){
        mo_type = 'nec-dhcp'
        expected_metrics = ["9148995037251908423","9148995033151907627","9148777916851236947",
                            "9148777928151239648","9148778345151886279","9148778346451886520",
